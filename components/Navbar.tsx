        ...
        <div className="flex justify-between items-center px-6 md:px-12 lg:px-16 h-14">
          ...
          <div className="hidden sm:flex items-center gap-6">
            ...
            <a
              ...
              className="text-sm font-medium px-3.5 py-1.5 rounded-md bg-philly-cta text-white hover:bg-philly-cta-hover transition-colors"
            >
              {t('nav.joinUs')}
            </a>
            <LanguageToggle />
        ...
        <div className="fixed inset-0 top-14 z-30 bg-cursor-bg/95 backdrop-blur-md sm:hidden">
          <div className="flex flex-col items-center gap-6 pt-12">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={closeMobile}
              className="text-base font-medium px-5 py-2.5 rounded-md bg-philly-cta text-white hover:bg-philly-cta-hover transition-colors"
            >
              {t('nav.joinUs')}
            </a>
          </div>
